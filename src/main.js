...
import ManagerAuth from './components/ManagerAuth.vue'
import BossAuth from './components/BossAuth.vue'
...
const routes = [
    ...
    {path: '/main', component: main,
        children: [
            ...
            {path: '/BossAuth', component: BossAuth},
            {path: '/ManagerAuth', component: ManagerAuth},
            {path: '/StaffAuth', component: StaffAuth}
        ]
    },
];
